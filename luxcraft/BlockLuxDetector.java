...
public class BlockLuxDetector extends BlockContainer
{
	public BlockLuxDetector(int par1)
	{
	...
	public boolean isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
	{
		if(par1IBlockAccess.getBlockTileEntity(par2, par3, par4)!= null){
			if(par1IBlockAccess.getBlockMetadata(par2, par3, par4) % 2==0){
				return ((TileEntityLuxDetector)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).luxDetectedTimer>0;
			}else{
				return ((TileEntityLuxDetector)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).luxDetectedTimer==0;
			}

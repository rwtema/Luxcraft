...
public class ContainerMiniChest extends Container
{
	...
	public ContainerMiniChest(IInventory par1IInventory, IInventory par2IInventory)
	{
		System.out.println("just checkn");
		this.lowerChestInventory = par2IInventory;
		this.numRows2 = 1;
		par2IInventory.openChest();
		int var3 = (this.numRows2 - 4) * 18;
		int var4;
		int var5;
		...
		//            {
		this.addSlotToContainer(new Slot(par2IInventory, 0, 8 + 4 * 18, 18 + 0 * 18));
		//            }
		//        }

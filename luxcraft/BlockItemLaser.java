...
public class BlockItemLaser extends BlockContainer
{
	public BlockItemLaser(int par1)
	{
	...
	{
		return par1 == par2 ? blockIndexInTexture : par1 == Facing.faceToSide[par2] ? 2 : 3;
	}
	...
	public void func_85107_d(int par1)
	{
		...
		if (par1 == 0)
		{
			this.setBlockBounds(w, 1.0F - var3, w, 1.0F-w, 1.0F, 1.0F-w);
		}

		if (par1 == 1)
		{
			this.setBlockBounds(w, 0, w, 1.0F-w, var3, 1.0F-w);
		}

		if (par1 == 2)
		{
			this.setBlockBounds(w, w, 1.0F - var3, 1.0F-w, 1.0F-w, 1.0F);
		}

		if (par1 == 3)
		{
			this.setBlockBounds(w, w, 0, 1.0F-w, 1.0F-w, var3);
		}

		if (par1 == 4)
		{
			this.setBlockBounds(1.0F - var3, w, w, 1.0F, 1.0F-w, 1.0F-w);
		}

		if (par1 == 5)
		{
			this.setBlockBounds(0, w, w, var3, 1.0F-w, 1.0F-w);
		}
	}
